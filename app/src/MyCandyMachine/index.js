...
const CandyMachine = ({ walletAddress }) => {
  ...
  /**
   * Essentially, this creates a new Provider object.
   *  The provider is how our web app talks to the Solana blockchain — it's gives our client a connection to Solana + our wallet credentials so we can talk to programs on Solana.
   * @returns Provider
  ...
  async function getCandyMachineState() {
    ...
    // IDL + PROGRM =  create a DB connection in web2? Well — here we're doing something similar lol. But, we're creating a connection to Solana.
